...
Route::get('/contact',[HomeController::class,'contactUs1'])->name('contact');
Route::post('contact-message',[ContactController::class,'sendMessage'])->name('contact.message');
Route::post('contact-message1',[ContactController::class,'sendMessage1'])->name('contact.message1');
...
Route::group(['as'=> 'staff.', 'prefix' => 'staff'],function (){
 ...
 Route::post('sauvegarde',[AdminPropertyController::class,'store']);
