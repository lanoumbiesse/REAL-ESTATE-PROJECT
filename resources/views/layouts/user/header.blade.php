            ...
            <div class="row">
                <div class="col-7 col-xl-6 col-md-8">
                    <div class="wsus__header_text">
                        <a href="mailto:{{ $topbar_contact->topbar_email  }}"><i class="fal fa-envelope"></i>{{ $topbar_contact->topbar_email }}</a>
                ...
                <div class="col-5 col-xl-6 col-md-4">
                    <ul class="wsus__header_icon">
                        ...
                        @if ($topbar_contact->tiktok)
                        <li><a href="{{ $topbar_contact->tiktok }}"><i class="fab fa-tiktok"></i></a></li>
                        @endif
                    </ul>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    @endif
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="https://ucgrealestate.ae/search-property?search=&city_id=&property_type=&page_type=list_view&purpose_type=1&minprice=&maxprice=">For Sale</a>
                    </li>
                    
                     <li class="nav-item">
                        <a class="nav-link" href="https://ucgrealestate.ae/search-property?search=&city_id=&property_type=&page_type=list_view&purpose_type=2&minprice=&maxprice=">For Rent</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="https://ucgrealestate.ae/search-property?search=&city_id=&property_type=&page_type=list_view&purpose_type=4&minprice=&maxprice=">Off Plan</a>
                    </li>
