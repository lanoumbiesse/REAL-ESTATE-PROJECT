                                ...
                                <form method="GET" action="{{ route('search-property') }}">
                                    ...
                                    <div class="wp_search_area">
                                        ...
                                        <select class="select_2" name="purpose_type">
                                            ...
                                            <option {{ request()->get('purpose_type') == 4 ? 'selected' : ''  }} value="4">{{ $websiteLang->where('lang_key','off-plan')->first()->custom_text }}</option>
                                            @else
                                            <option value="">{{ $websiteLang->where('lang_key','any')->first()->custom_text }}</option>
                                            ...
                                            <option value="3">{{ $websiteLang->where('lang_key','off-plan')->first()->custom_text }}</option>
                                            @endif
                                        </select>
                                    </div>
                                    
                                      <div class="wsus__single_input">
                                        <label for="#">{{ $websiteLang->where('lang_key','min-price')->first()->custom_text }}</label>
                                        <input type="text" placeholder="{{ $websiteLang->where('lang_key','search_type')->first()->custom_text }}" name="minprice">
                                    </div>
                                    
                                     <div class="wsus__single_input">
                                        <label for="#">{{ $websiteLang->where('lang_key','max-price')->first()->custom_text }}</label>
                                        <input type="text" placeholder="{{ $websiteLang->where('lang_key','search_type')->first()->custom_text }}" name="maxprice">
                                    </div>
                                        ...
                                        <div class="wsus__list_item">
                                            <a href="{{ route('property.details',$item->property->slug) }}" class="wsus__list_item_img">
                                                ...
                                                <span class="mark">{{ $item->property->propertyPurpose->custom_purpose }}</span>
                                                 ...
                                                 @elseif($item->property->property_purpose_id==4)
                                                <span class="mark">{{ $item->property->propertyPurpose->custom_purpose }}</span>
                                                @endif
