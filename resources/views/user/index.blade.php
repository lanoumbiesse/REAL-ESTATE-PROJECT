                        ...
                        <div class="col-xl-12">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button style="border-radius:15px" class="nav-link active" id="pills-any-tab" data-bs-toggle="pill" data-bs-target="#pills-any" type="button" role="tab" aria-controls="pills-any" aria-selected="true">{{ $websiteLang->where('lang_key','any')->first()->custom_text }}</button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                 ...
                                 <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-off-tab" data-bs-toggle="pill" data-bs-target="#pills-off" type="button" role="tab" aria-controls="pills-off" aria-selected="false">{{ $websiteLang->where('lang_key','off-plan')->first()->custom_text }}</button>
                                </li>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <form method="GET" action="{{ route('search-property') }}">
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="purpose_type" value="">
                                             <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <div class="wp_search_area home_page_search_box">
                                                    <input type="text" placeholder="{{ $websiteLang->where('lang_key','min-price')->first()->custom_text }}" name="minprice">
                                                </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <div class="wp_search_area home_page_search_box">
                                                    <input type="text" placeholder="{{ $websiteLang->where('lang_key','max-price')->first()->custom_text }}" name="maxprice">
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                 ...
                                 <div class="tab-pane fade" id="pills-off" role="tabpanel" aria-labelledby="pills-off-tab">
                                    <form method="GET" action="{{ route('search-property') }}">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <div class="wp_search_area home_page_search_box">
                                            ...
                                            <input type="hidden" name="page_type" value="list_view">
                                            <input type="hidden" name="purpose_type" value="3">
                                           <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <div class="wp_search_area home_page_search_box">
                                                    <input type="text" placeholder="{{ $websiteLang->where('lang_key','min-price')->first()->custom_text }}" name="minprice">
                                                </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="wsus__single_property">
                                <a class="wsus__single_pro_img" href="{{ route('property.details',$featured_item->slug) }}">
                                    ...
                                    <span class="mark">{{ $featured_item->propertyPurpose->custom_purpose }}</span>
                                    @elseif ($featured_item->property_purpose_id==4)
                                     <span class="mark">{{ $featured_item->propertyPurpose->custom_purpose }}</span>
                                    @endif
                ...
                <div class="row testi_slider">
                    ...
                    @foreach ($testimonials->take($testimonial_section->content_quantity) as $item)
                          ...
                          <!--     <p><i class="fal fa-quote-left" id="top_icon"></i> {{ $item->description }}</p> -->
                               <a target="_blank" href = "{{ $item->description }}"> <img src="{{ url($item->image) }}" alt="clients"> </a>
